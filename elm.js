...
var _user$project$Point$renderPoints = F2(
	function (label, list) {
		return {
			ctor: '::',
			_0: A2(
				_elm_lang$svg$Svg$svg,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$width('320'),
						_1: {ctor: '[]'}
					}
				},
				A2(
					...
					function (element) {
						return A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_mdgriffith$elm_style_animation$Animation$render(element.style),
								{
									ctor: '::',
...
var _user$project$Point$updateStyles = function (element) {
	return _elm_lang$core$Native_Utils.update(
		element,
		{
			style: A2(
				_mdgriffith$elm_style_animation$Animation$interrupt,
				{
					...
					_0: _mdgriffith$elm_style_animation$Animation$to(
						{
							ctor: '::',
							_0: _mdgriffith$elm_style_animation$Animation$x(
								_elm_lang$core$Basics$toFloat(element.xPosition)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
...
var _user$project$Point$updatePosition = F2(
	function (newPosition, point) {
		return _elm_lang$core$Native_Utils.update(
			point,
			{xPosition: newPosition * 20});
	});
var _user$project$Point$animateElement = F2(
	function (time, element) {
		return _elm_lang$core$Native_Utils.update(
			element,
			{
				style: A2(_mdgriffith$elm_style_animation$Animation$update, time, element.style)
			});
	});
var _user$project$Point$Point = F3(
	function (a, b, c) {
		return {value: a, xPosition: b, style: c};
	});
var _user$project$Point$init = function (xs) {
	return A2(
		_elm_lang$core$List$indexedMap,
		F2(
			function (i, x) {
					...
					_mdgriffith$elm_style_animation$Animation$style(
						{
							ctor: '::',
							_0: _mdgriffith$elm_style_animation$Animation$x(
								_elm_lang$core$Basics$toFloat(20 * i)),
							_1: {
								ctor: '::',
								_0: _mdgriffith$elm_style_animation$Animation$y(
									_elm_lang$core$Basics$toFloat(100 - x)),
								_1: {
									ctor: '::',
									_0: _mdgriffith$elm_style_animation$Animation$fill(
										A3(
											_elm_lang$core$Color$hsl,
											_elm_lang$core$Basics$toFloat(x) * 5.0e-2,
											20.0,
											20.0)),
									_1: {
										ctor: '::',
...
var _user$project$MergeSort$merge = F3(
	function (left, right, sorted) {
		merge:
		while (true) {
			var _p0 = left;
			if (_p0.ctor === '[]') {
				return A2(_elm_lang$core$Basics_ops['++'], sorted, right);
			} else {
				var _p3 = _p0._0;
				var _p1 = right;
				if (_p1.ctor === '[]') {
					return A2(_elm_lang$core$Basics_ops['++'], sorted, left);
				} else {
					var _p2 = _p1._0;
					if (_elm_lang$core$Native_Utils.cmp(_p3.value, _p2.value) < 0) {
						var _v2 = _p0._1,
							_v3 = right,
							_v4 = A2(
							_elm_lang$core$Basics_ops['++'],
...
var _user$project$MergeSort$mergeSort = function (unsorted) {
	if (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(unsorted),
		1) < 1) {
		return unsorted;
	} else {
		var middle = (_elm_lang$core$List$length(unsorted) / 2) | 0;
		var left = A2(_elm_lang$core$List$take, middle, unsorted);
		var right = A2(_elm_lang$core$List$drop, middle, unsorted);
		return A3(
			_user$project$MergeSort$merge,
			_user$project$MergeSort$mergeSort(left),
			_user$project$MergeSort$mergeSort(right),
			{ctor: '[]'});
	}
};
var _user$project$MergeSort$view = function (list) {
	return A2(_user$project$Point$renderPoints, 'Merge Sort', list);
};
var _user$project$MergeSort$animate = F2(
	function (time, newList) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Point$animateElement(time),
			newList);
	});
var _user$project$MergeSort$update = function (unsorted) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$Point$updateStyles,
		A2(
			_elm_lang$core$List$indexedMap,
			function (i) {
				return _user$project$Point$updatePosition(i);
			},
			unsorted));
};
var _user$project$MergeSort$MergeList = F2(
	function (a, b) {
		return {sorted: a, unsorted: b};
	});
var _user$project$MergeSort$SortedList = function (a) {
	return {ctor: 'SortedList', _0: a};
};
var _user$project$MergeSort$init = function (unsorted) {
	return {
		unsorted: unsorted,
		sorted: _user$project$MergeSort$SortedList(
			{ctor: '[]'})
	};
};
var _user$project$MergeSort$SortBuffer = F3(
	function (a, b, c) {
		return {ctor: 'SortBuffer', _0: a, _1: b, _2: c};
	});

var Elm = {};
Elm['MergeSort'] = Elm['MergeSort'] || {};
if (typeof _user$project$MergeSort$main !== 'undefined') {
    _user$project$MergeSort$main(Elm['MergeSort'], 'MergeSort', undefined);
}
